...
//   console.log("[contacts.get] called with query:", req.query);
...
//       hash: 0,
//     });
//     console.log("[contacts.get] Success, users count:", result.users.length);
...
//     res.status(500).json({
//       success: false,
//       error: error.error_message || error.message || "Failed to get contacts",
//     });
//   }
// };

// // Bulk create contacts with validation and last seen check
// exports.bulkCreate = async (req, res) => {
//   console.log("[contacts.bulkCreate] called with body:", req.body);
//   const { number, name_prefix, generate, phone } = req.body;
...
//     try {
//       console.log(`[contacts.bulkCreate] Checking phone: ${c.phone}`);
...
//     } catch (err) {
//       console.error("[contacts.bulkCreate] Failed to import contacts:", err);
